...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/sysconfig/preinstalled-packages-platform-leeco-product.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/preinstalled-packages-platform-leeco-product.xml \
    prebuilts/vndk/v32/arm/arch-arm-armv7-a-neon/shared/vndk-core/libstagefright_foundation.so:$(TARGET_COPY_OUT_VENDOR)/lib/libstagefright_foundation-v32.so \
...
# Unlimited Gphotos for Vanilla build with MicroG
ifneq ($(LEGION_GAPPS), true)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/sysconfig/nexus.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/nexus.xml
endif
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/thermals/thermal-engine.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-cbg.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-cbg.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-eui30s.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-eui30s.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-eui19s.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-eui19s.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-video.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-video.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-balanced.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-balanced.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-battery.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-battery.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-performance.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-performance.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-gaming.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-gaming.conf \
    $(LOCAL_PATH)/configs/thermals/thermal-engine-maxplus.conf:$(TARGET_COPY_OUT_VENDOR)/etc/thermal-engine-maxplus.conf
